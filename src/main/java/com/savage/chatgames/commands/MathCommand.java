    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if(cmd.getName().equalsIgnoreCase("math")) {
            ...
            if(args.length == 2 && args[0].equals("answer")) {
                ...
                if(args[1].equalsIgnoreCase(Integer.toString(math.result))) {
                    rewards.giveReward(p, math.difficulty);
                    ...
                    if (solveAnnouncement != null) {
                        ...
                        solveAnnouncement = solveAnnouncement.replace("%solution%", Integer.toString(math.result));
